...
SliverPy is a Python gRPC client library for [Sliver](https://github.com/BishopFox/sliver). SliverPy can be used to automate any operator interaction with Sliver using Sliver client configuration files, and connects to servers using gRPC over Mutual TLS (i.e., multiplayer). 
